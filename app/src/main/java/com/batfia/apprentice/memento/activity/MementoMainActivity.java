package com.batfia.apprentice.memento.activity;
...
import com.batfia.apprentice.App;
...
import com.batfia.apprentice.memento.dialog.ImportDialog;
import com.batfia.apprentice.memento.dialog.SaveDialog;
import com.batfia.apprentice.memento.fragment.MainFragment;
import com.batfia.apprentice.memento.fragment.template.RecyclerFragment;
import com.batfia.apprentice.memento.inner.Animator;

public class MementoMainActivity extends AppCompatActivity implements RecyclerFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (checkForPermission) {
			...
			if (ContextCompat.checkSelfPermission(MementoMainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
						...
						public void run() {
							switch (type) {
								case Drawer.TYPE_ABOUT:
									new MaterialDialog.Builder(MementoMainActivity.this)
	...
	*/
	...
	private void requestPermission() {
		ActivityCompat.requestPermissions(MementoMainActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.memento_main_menus, menu);
		return true;
	}
