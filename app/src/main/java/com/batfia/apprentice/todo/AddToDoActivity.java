...
//        setContentView(R.layout.activity_add_to_do);
        ...
        mUserToDoItem = (ToDoItem)getIntent().getSerializableExtra(TodosMainActivity.TODOITEM);
...
//        }
        ...
        if(theme.equals(TodosMainActivity.DARKTHEME)){
...
//            mTimeEditText.setText(timeOption);
    ...
    private String getThemeSet(){
        return getSharedPreferences(TodosMainActivity.THEME_PREFERENCES, MODE_PRIVATE).getString(TodosMainActivity.THEME_SAVED, TodosMainActivity.LIGHTTHEME);
    }
...
//        mUserToDoItem.setLastEdited(mLastEdited);
        ...
        i.putExtra(TodosMainActivity.TODOITEM, mUserToDoItem);
        setResult(result, i);
    }
