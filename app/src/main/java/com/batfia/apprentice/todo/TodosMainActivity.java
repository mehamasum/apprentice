...
public class TodosMainActivity extends AppCompatActivity {
    private RecyclerViewEmptySupport mRecyclerView;
    private FloatingActionButton mAddToDoItemFAB;
    private ArrayList<ToDoItem> mToDoItemsArrayList;
    private CoordinatorLayout mCoordLayout;
    public static final String TODOITEM = "com.avjindersinghsekhon.com.avjindersinghsekhon.minimaltodo.TodosMainActivity";
    ...
    public static ArrayList<ToDoItem> getLocallyStoredData(StoreRetrieveData storeRetrieveData){
        ...
        Log.e("meha", "TOL: "+ items.size());
        for(ToDoItem a : items) {
            Log.e("meha", "TOL: "+ a.getToDoText());
        }
        return items;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddToDoItemFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent newTodo = new Intent(TodosMainActivity.this, AddToDoActivity.class);
...
//        Log.d("OskarSchindler", "createAlarm "+requestCode+" time: "+timeInMillis+" PI "+pi.toString());
    ...
    public class BasicListAdapter extends RecyclerView.Adapter<BasicListAdapter.ViewHolder> implements ItemTouchHelperClass.ItemTouchHelperAdapter{
        ...
        public void onItemRemoved(final int position) {
            ...
            Intent i = new Intent(TodosMainActivity.this,TodoNotificationService.class);
        ...
        public BasicListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_todos, parent, false);
...
//            TextDrawable myDrawable = TextDrawable.builder().buildRound(item.getToDoText().substring(0,1),holder.color);
            ...
            if(item.getToDoDate()!=null){
                String timeToShow;
                if(android.text.format.DateFormat.is24HourFormat(TodosMainActivity.this)){
                    timeToShow = AddToDoActivity.formatDate(TodosMainActivity.DATE_TIME_FORMAT_24_HOUR, item.getToDoDate());
                }
                else{
                    timeToShow = AddToDoActivity.formatDate(TodosMainActivity.DATE_TIME_FORMAT_12_HOUR, item.getToDoDate());
                }
            ...
            public ViewHolder(View v){
                ...
                v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(TodosMainActivity.this, AddToDoActivity.class);
