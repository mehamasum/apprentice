...
public class ReminderActivity extends AppCompatActivity{
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        theme = getSharedPreferences(TodosMainActivity.THEME_PREFERENCES, MODE_PRIVATE).getString(TodosMainActivity.THEME_SAVED, TodosMainActivity.LIGHTTHEME);
        if(theme.equals(TodosMainActivity.LIGHTTHEME)){
        ...
        storeRetrieveData = new StoreRetrieveData(this, TodosMainActivity.FILENAME);
        mToDoItems = TodosMainActivity.getLocallyStoredData(storeRetrieveData);
...
//        mSnoozeSpinner.setSelection(0);
    ...
    private void closeApp(){
        Intent i = new Intent(ReminderActivity.this, TodosMainActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//        i.putExtra(EXIT, true);
        SharedPreferences sharedPreferences = getSharedPreferences(TodosMainActivity.SHARED_PREF_DATA_SET_CHANGED, MODE_PRIVATE);
    ...
    private void changeOccurred(){
        SharedPreferences sharedPreferences = getSharedPreferences(TodosMainActivity.SHARED_PREF_DATA_SET_CHANGED, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(TodosMainActivity.CHANGE_OCCURED, true);
//        editor.commit();
        editor.apply();
    }
